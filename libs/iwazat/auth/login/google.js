 ...
 * @param infoObj Information received from the Google authentication
...
// User is registered (new users from social network don't will save in database here)
  user.save(function (err) {
    ...
    if (err) {
      ...
      globalLogger.error('lib: iWazat/auth # module: login/google. Error when saving the user ' +
        'document updates received from the Google. | Error details: ' + err);
    }
  ...
  }); // End saving registered user information received from Google
};