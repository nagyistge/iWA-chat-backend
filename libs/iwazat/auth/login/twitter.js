 ...
 * @param infoObj Information received from the Twitter authentication
...
// User is registered (new users from social network don't will save in database here)
  user.save(function (err) {
    ...
    if (err) {
      ...
      globalLogger.error('lib: iWazat/auth # module: login/twitter. Error when saving the user ' +
        'document updates received from the Twitter. | Error details: ' + err);
    }
  ...
  }); // End saving registered user information received from Twitter
};